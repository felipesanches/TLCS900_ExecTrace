...
class TLCS900H_Trace(ExecTrace):
    def getLabelName(self, addr):
        ...
        elif addr in self.subroutines:  # TODO: rename this variable (POSSIBLY_UNUSED_CODEBLOCKS)
    ...
    def load_interrupt_vector(self):
        ...
        for int_num in range(0x2D): # FIXME: what are all entries we should read from the table?
            v = vector + int_num * 4
            address = self.rom[reloc_index][v + 0]
...
if __name__ == '__main__':
    ...
    print(f"There are at least {trace.count_warns} jump tables in this binary.")
